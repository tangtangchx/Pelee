...
parser.add_argument('--step-value', '-s', nargs='+', type=int, default=[10000, 20000, 40000],
...
train_data = "examples/Pelee/trainval_lmdb"
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = "examples/Pelee/test_lmdb"
...
save_dir = "examples/Pelee/model/{}/VOC0712/{}".format(model_prefix, job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "examples/Pelee/model1/{}/VOC0712/{}".format(model_prefix,job_name)
# Directory which stores the job script and log file.
job_dir = "examples/Pelee/jobs1/{}/VOC0712/{}".format(model_prefix,job_name)
# Directory which stores the detection results.
output_result_dir = "examples/Pelee/results/"
